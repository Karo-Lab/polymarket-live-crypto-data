// use exchanges_common::traits::{ExchangeAdapter, ExchangeConnectorAdapter};
...
//     fn get_instrument<'a>(&self, msg: &Self::InputBookData<'_>) -> String {
//         match msg {
//             PolyCLOBMessage::Snapshot(snap) => snap.asset_id.to_string(),
//             PolyCLOBMessage::L2Tick(tick) => tick.market.to_string(),
//             PolyCLOBMessage::LastTrade(trade) => trade.asset_id.to_string()
//         }
//     }
...
//     }
//     fn apply<'a>(&self,core: &mut exchanges_common::models::OrderBookL2, msg: &Self::InputBookData<'_>) {
//         match msg {
...
//     }
//     fn route_message(&self, msg: &impl AsRef<[u8]>) -> Result<u128, exchanges_common::error::ConnectorError> {
//         unimplemented!()
//     }
// }